...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({
    ...
    makePopupURL: function() {
        ...
        var sPopupUrl = "./se2/sample/photo_uploader/photo_uploader_noti_modify.html";
    ...
    _getPhotoTag: function(htPhotoInfo) {
        ...
        // var sTag = '<img src="{=sOriginalImageURL}" title="{=sName}" style="max-width:596px; height:auto;">';
