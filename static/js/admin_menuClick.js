...
let adMenuLi = document.querySelector(".adArticle");
// let adMenuLi = document.querySelector(".adminMenuLi");
let adMenuLiDis = adMenuLi.style.visibility;

let mL;
for (mL = 0; mL < adMenu.length; mL++) {
    adMenu[mL].onclick = function() {
        if (adMenuLiDis == "hidden") {
            adMenuLi.style.visibility = "visible";
            adMenuLiDis = "visible";
        } else if (adMenuLiDis !== "hidden") {
            adMenuLi.style.visibility = "hidden";
            adMenuLiDis = "hidden";
        } else {
            adMenuLi.style.visibility = "visible";
            adMenuLiDis = "visible";
